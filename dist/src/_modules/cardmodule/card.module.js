...
const card_entity_1 = require("../../_entities/card.entity");
...
exports.CardModule = CardModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([card_entity_1.Card]), (0, common_1.forwardRef)(() => auth_module_1.AuthModule)],
